...
export default class Status extends BrowseCommand {
  static override description = "Show the browse driver daemon status for a named session.";

  static override examples = ["browse status", "browse status --session research"];
