...
export default class Cursor extends BrowseCommand {
  static override description = "Enable a visible cursor overlay in the active browser page.";

  static override examples = ["browse cursor", "browse cursor --session research"];
