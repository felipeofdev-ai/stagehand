...
export default class NetworkOn extends BrowseCommand {
  static override description = "Enable network capture for the active browser session.";

  static override examples = ["browse network on", "browse network on --session research"];
